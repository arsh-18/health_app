        ...
        <div className='grid grid-cols-1 lg:grid-cols-2'>
          ...
          <div className='rounded-l-lg lg:pl-16 py-10'>
            ...
            <form className="py-4 md:py-0" onSubmit={submitHandler}>
              ...
              <div className="mt-7">
                <button disabled={loading && true} type='submit' className='w-full bg-primaryColor text-white text-[20px] leading-[30px] rounded-lg px-4 py-3'>{loading ? (<HashLoader size={35} color='white'/>)  : ('Sign Up')} </button>
              </div>
